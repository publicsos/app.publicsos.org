...
Our commitment to social responsibility includes:

1. Information Distribution
   - Keep people informed across multiple channels:
     - Email
     - SMS
     - Social media
     - WhatsApp
...
2. Public Communication
   - Maintain regular updates on latest developments through blogs and social media (TBA - managed by Bogdan)

3. Environmental Impact
   - Focus on reducing carbon footprint
   - Improve public environmental quality
   - Tree planting initiative: Each registered user contributes to planting a tree (proof required)

## Technical
Reference: [Decision](developer-domain/18022025.md)

## Legal
Legal department oversees all organizational legal matters.

Reference: [See Readme](business-domain/administration/readme.md)
