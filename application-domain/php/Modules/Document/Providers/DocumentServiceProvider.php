...
class DocumentServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->registerConfig();
        $this->registerViews();
        $this->loadMigrationsFrom(base_path('Modules/Document/database/migrations'));
    ...
    {
        $this->publishes([
            base_path('Modules/Document/Config/config.php') => config_path($this->moduleNameLower.'.php'),
        ], 'config');
        $this->mergeConfigFrom(
            base_path('Modules/Document/Config/config.php'), $this->moduleNameLower
        );
    }
    ...
    public function registerViews()
    {
        ...
        $sourcePath = base_path('Modules/Document/Resources/views');
