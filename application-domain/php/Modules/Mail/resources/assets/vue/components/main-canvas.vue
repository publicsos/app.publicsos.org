...
import CampaignNode from '@/components/vue-flow/nodes/campaign-node.vue'
...
<template>
  <div class="relative w-full h-full" id="main-canvas" @drop="handleOnDrop" @dragover="handleOnDragOver">
