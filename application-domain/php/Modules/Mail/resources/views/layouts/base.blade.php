...
<head>
    ...
    <!-- Fav Icon !-->
    <link rel="icon" href="{{ asset('logo2.svg') }}" type="image/svg+xml">
...
@stack('js')
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-FJEH3K098K"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-FJEH3K098K');
</script>
</body>
</html>
