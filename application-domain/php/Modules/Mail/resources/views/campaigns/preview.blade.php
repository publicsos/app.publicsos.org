...
<div class="container-fluid">
    <div class="row">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form class="form-horizontal">
                        <div class="row">
                            <label class="col-sm-2 col-form-label text-white">{{ __('From') }}:</label>
                            <div class="col-sm-10">
                                <b class="text-white">
                                    <span class="form-control-plaintext text-white">{{ $campaign->from_name . ' <' . $campaign->from_email . '>' }}</span>
                                </b>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label text-white">{{ __('Subject') }}:</label>
                            <div class="col-sm-10">
                                <b>
                                    <span class="form-control-plaintext text-white">{{ $campaign->subject }}</span>
                                </b>
                            </div>
                        </div>
        ...
        <div class="col-md-4">
            ...
            <form action="{{ route('laravel-mail.campaigns.test', $campaign->id) }}" method="POST">
                @csrf
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <button type="submit" class="btn btn-sm btn-primary text-white">{{ __('Send Test Email') }}</button>
                        </div>
                    </div>
                </div>
            </form>

            <form action="{{ route('laravel-mail.campaigns.send', $campaign->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="card mb-4">
                    <div class="card-header text-white">
                ...
                <div>
                    <a href="{{ route('laravel-mail.campaigns.index') }}" class="btn btn-warning">{{ __('Cancel') }}</a>
