<div id="settings-overlay" class="container settings-overlay">
    <div class="row">
        <div class="col-md-12" style="margin-bottom: 20px;">
            <div class="settings-headline">
                <h1>{!! $element::$icon !!} {{ $element::getTranslation()  }} {{__('Workflow Task Settings') }}</h1>
            </div>
        </div>
        <div class="col-md-12">
            <div class="settings-body">
                <?php
                $commonFields = $element::$commonFields;
                $fields = $element::$fields;
                $output = $element::$output;

                //dd($commonFields, $fields, $output);
                ?>
