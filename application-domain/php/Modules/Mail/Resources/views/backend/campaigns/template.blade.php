...
@section('content')
    ...
    {!! Form::model($campaign, ['id' => 'form-template-selector', 'method' => 'put', 'route' => ['backend.campaigns.template.update', $campaign->id]]) !!}
        ...
        @foreach($templates as $template)
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 template-item">
                <div class="card">
                    ...
                    <div class="card-body">
                        @include('mail::backend.templates.partials.griditem')
                    </div>
                </div>
            </div>
        @endforeach
    ...
    <a href="{{ route('backend.campaigns.edit', $campaign->id) }}" class="btn btn-link">
