...
use Modules\Mail\Models\User;
use Modules\Mail\Models\Workspace;
use Modules\Mail\Rules\ValidInvitation;
use Modules\Mail\Services\Workspaces\AcceptInvitation;
use Modules\Mail\Services\Workspaces\CreateWorkspace;
use Modules\Mail\Traits\ChecksInvitations;
...
class RegisterController extends Controller
{
    ...
    {
        return route('laravel-mail.dashboard');
    }
}
