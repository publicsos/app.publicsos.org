...
use Modules\Mail\Http\Requests\TemplateStoreRequest;
use Modules\Mail\Http\Requests\TemplateUpdateRequest;
use Modules\Mail\Repositories\TemplateTenantRepository;
use Modules\Mail\Services\Templates\TemplateService;
...
class TemplatesController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('mail::backend.templates.index', compact('templates', 'searchQuery', 'searchTerm'));
    }
    ...
    {
        return view('mail::backend.templates.create');
    }
    ...
    public function edit(int $id): View
    {
        ...
        return view('mail::backend.templates.edit', compact('template'));
    }
