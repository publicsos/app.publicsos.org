...
use LaravelCompany\Mail\Transport\CustomSmtpNotificationTransport;
...
class SmtpNotificationAdapter extends BaseMailAdapter
{
    /** @var Mailer */
    protected $client;
    ...
    protected function resolveTransport(): CustomSmtpNotificationTransport
    {
        if ($this->transport) {
        ...
        // Create transport directly instead of using factory
        $this->transport = new CustomSmtpNotificationTransport(
        ...
        if ($username = config('mail.mailers.smtp.username')) {
            $this->transport->setUsername($username);
            $this->transport->setPassword(config('mail.mailers.smtp.password'));
        }
