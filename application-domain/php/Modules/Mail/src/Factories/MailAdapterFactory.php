...
namespace LaravelCompany\Mail\Factories;

use InvalidArgumentException;
use LaravelCompany\Mail\Adapters\MailgunMailAdapter;
use LaravelCompany\Mail\Adapters\MailjetAdapter;
use LaravelCompany\Mail\Adapters\PostalAdapter;
use LaravelCompany\Mail\Adapters\PostmarkMailAdapter;
use LaravelCompany\Mail\Adapters\SendgridMailAdapter;
use LaravelCompany\Mail\Adapters\SesMailAdapter;
use LaravelCompany\Mail\Adapters\SmtpAdapter;
use LaravelCompany\Mail\Adapters\ZeptomailAdapter;
