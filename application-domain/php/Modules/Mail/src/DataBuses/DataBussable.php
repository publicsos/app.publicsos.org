...
trait DataBussable
{
    ...
    {
        info('Getting value for from the dataBus -> ' . $value);
     ...
     * @return void
     */
    public function setDataArray(string $key,mixed $value): void
    {
     ...
     * @return void
     */
    public function setData(mixed $key, mixed $value): void
    {
