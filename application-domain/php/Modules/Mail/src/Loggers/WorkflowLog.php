...
use LaravelCompany\Mail\Models\BaseModel;
...
class WorkflowLog extends BaseModel
{
    ...
    {
        return $this->hasMany(TaskLog::class, 'workflow_log_id');
    }
    ...
    {
        $this->message = $errorMessage . json_encode($dataBus);
    ...
    public function addTaskLog(int $workflow_log_id, int $task_id, string $task_name, string $status, string $message, mixed $start, mixed $end = null): void
    {
