...
class Message extends BaseModel
{
    ...
    public function isAutomation(): bool
     {
        //return $this->source_type === Automation::class;
        return false;
     }
    ...
    {
        return $this->source_type === Task::class;
    }

    /**
     *
     * a messaage gets created when we dispatch it from capign , but we can have a service/take repo/ use that to create a message , dont forget in the diagram
     * Determine if this message is for an automation.
     *
     * @return bool
     */
    ...
    {
        return $this->source_type === Workflow::class;
    }
    /**
    ...
    public function getSourceStringAttribute(): ?string
    {
        ...
        if ($this->source_type === Workflow::class) {
            return 'Workflow';
        }
