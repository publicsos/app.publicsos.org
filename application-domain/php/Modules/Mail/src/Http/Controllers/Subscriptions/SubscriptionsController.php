...
namespace LaravelCompany\Mail\Http\Controllers\Subscriptions;

use Illuminate\Http\RedirectResponse;
use Illuminate\View\View;
use LaravelCompany\Mail\Http\Controllers\Controller;
use LaravelCompany\Mail\Http\Requests\SubscriptionToggleRequest;
...
class SubscriptionsController extends Controller
{
    ...
    public function unsubscribe(string $messageHash): View
    {
        ...
        return view('laravel-mail::subscriptions.unsubscribe', compact('message'));
    }
    ...
    public function subscribe(string $messageHash): View
    {
        ...
        return view('laravel-mail::subscriptions.subscribe', compact('message'));
    }
    ...
    public function update(SubscriptionToggleRequest $request, string $messageHash): RedirectResponse
    {
        ...
        if ($unsubscribed) {
            ...
            return redirect()->route('laravel-mail.subscriptions.subscribe', $message->hash)
        ...
        return redirect()->route('laravel-mail.subscriptions.unsubscribe', $message->hash)
