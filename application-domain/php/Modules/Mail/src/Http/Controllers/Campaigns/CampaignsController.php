...
use LaravelCompany\Mail\Services\Agents\CloudflareAgent;
...
class CampaignsController extends Controller
{
    ...
    {
        $params = ['draft' => true];
        $campaigns = $this->campaigns->paginate(LaravelMail::currentWorkspaceId(), 'created_atDesc', ['status'], 25, $params);

        return view('laravel-mail::campaigns.index', [
            'campaigns' => $campaigns,
            'campaignStats' => $this->campaignStatisticsService->getForPaginator($campaigns, LaravelMail::currentWorkspaceId()),
        ]);
    }
    ...
    public function generate(): ViewContract
    {
        ...
        return view('laravel-mail::campaigns.generate', compact('templates', 'emailServices'));
    }
    ...
    public function rewrite():mixed
    {
        ...
        //TODO - Write the response to db or something
