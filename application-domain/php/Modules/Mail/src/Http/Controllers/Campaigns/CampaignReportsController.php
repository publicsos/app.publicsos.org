...
class CampaignReportsController extends Controller
{
    ...
    public function index(int $id, Request $request)
    {
        ...
        $presenter = new CampaignReportPresenter($campaign, LaravelMail::currentWorkspaceId(), (int) $request->get('interval', 48));
    ...
    public function opens(int $id)
    {
        ...
        $messages = $this->messageRepo->opens(LaravelMail::currentWorkspaceId(), Campaign::class, $id);
    ...
    public function clicks(int $id)
    {
        ...
        $messages = $this->messageRepo->clicks(LaravelMail::currentWorkspaceId(), Campaign::class, $id);
    ...
    public function bounces(int $id)
    {
        ...
        $messages = $this->messageRepo->bounces(LaravelMail::currentWorkspaceId(), Campaign::class, $id);
    ...
    public function unsubscribes(int $id)
    {
        ...
        $messages = $this->messageRepo->unsubscribes(LaravelMail::currentWorkspaceId(), Campaign::class, $id);
