...
class LaravelMailService
{
     ...
     {
         $this->app->make('router')->registerPublicApiRoutes();
     }
 
     /**
      * @throws BindingResolutionException
      */
     public function privateApiRoutes(): void
     {
         $this->app->make('router')->registerPrivateApiRoutes();
     }
     ...
     {
         $this->app->make('router')->registerPublicRoutes();
     }
 
     /**
      * @throws BindingResolutionException
      */
     public function privateRoutes(): void
     {
         $this->app->make('router')->registerPrivateRoutes();
     }
