<div>
    ...
    <section class="p-6 mx-auto max-w-screen-xl text-gray-600 bg-white sm:p-20">
        <div class="grid grid-cols-1">
            ...
            <h3 class="mt-4 mb-2 text-2xl">Cookies</h3>
            <p>
            ...
            <h3 class="mt-4 mb-2 text-2xl">License</h3>
            <p>
            ...
            <h3 class="mt-4 mb-2 text-2xl">You must not:</h3>
            ...
            <h3 class="mt-4 mb-2 text-2xl">This Agreement shall begin on the date hereof.</h3>
            <p>
            ...
            <h3 class="mt-4 mb-2 text-2xl">Hyperlinking to our Content</h3>
            ...
            <h3 class="mt-4 mb-2 text-2xl">Approved organizations may hyperlink to our Website as follows:</h3>
            <ul class="list-disc list-inside">
            ...
            <h3 class="mt-4 mb-2 text-2xl">iFrames</h3>
            <p>
            ...
            <h3 class="mt-4 mb-2 text-2xl">Content Liability</h3>
            <p>
            ...
            <h3 class="mt-4 mb-2 text-2xl">Reservation of Rights</h3>
            <p>
            ...
            <h3 class="mt-4 mb-2 text-2xl">Removal of links from our website</h3>
            <p>
            ...
            <h3 class="mt-4 mb-2 text-2xl">Disclaimer</h3>
            <p>
