...
@section("content")
    <section class="bg-white dark:bg-gray-800">
        <div class="px-4 py-24 mx-auto max-w-screen-xl text-center sm:px-12">
            <h1 class="mb-6 text-4xl font-extrabold tracking-tight leading-none text-white-900 dark:text-white sm:text-6xl">
                Public SOS
            </h1>
    ...
    <section class="bg-white dark:bg-gray-900">
        ...
        <div class="px-4 py-8 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <!-- Executive Summary -->
            <div class="mb-12">
                <h2 class="mb-4 text-4xl font-bold text-gray-900 dark:text-white">I. Executive Summary</h2>
                <div class="max-w-none text-3xl text-white prose dark:prose-invert">
                    <p>This business plan outlines the strategy and operational framework for a incident management team, adhering to the Public Safety and rescue service guidelines.</p>
                    <br />
        ...
        <div class="px-4 py-8 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            ...
            <div class="mb-12" style="margin-bottom:6vh">
                ...
                <div class="max-w-none prose dark:prose-invert">
                    <h3 class="mb-3 text-3xl font-bold text-white">Purpose</h3>
                    <p class="mb-6 text-white">To establish a robust framework for managing emergency incidents, ensuring the safety of personnel, protection of communities, and preservation of natural resources.</p>

                    <h3 class="mt-6 mb-3 text-2xl font-bold text-white">Objectives</h3>
                    <ul class="pl-6 space-y-2 text-white list-disc-none">
            ...
            <div class="mt-12 mb-12">
                ...
                <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div class="p-6 bg-gray-50 rounded-lg dark:bg-gray-800">
                        <h3 class="mb-3 text-xl font-bold text-white">Year 1: Initial Setup</h3>
                    ...
                    <!-- Year 2 -->
                    <div class="p-6 bg-gray-50 rounded-lg dark:bg-gray-800">
                        <h3 class="mb-3 text-xl font-bold text-white">Year 2: Implementation</h3>
                        <ul class="space-y-2 text-gray-600 dark:text-gray-400">
                    ...
                    <!-- Years 3-5 -->
                    <div class="p-6 bg-gray-50 rounded-lg dark:bg-gray-800">
                        <h3 class="mb-3 text-xl font-bold text-white">Years 3-5: Expansion</h3>
                        <ul class="space-y-2 text-gray-600 dark:text-gray-400">
            ...
            <div class="mb-12" style="margin-top:3vh">
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    <div class="p-6 bg-gray-50 rounded-lg dark:bg-gray-800">
                        <h3 class="mb-3 text-xl font-bold text-white">Weather Effects</h3>
                        <p class="text-gray-600 dark:text-gray-400">Understanding and predicting the impact of weather conditions on emergency response capabilities.</p>
                    </div>
                    <div class="p-6 bg-gray-50 rounded-lg dark:bg-gray-800">
                        <h3 class="mb-3 text-xl font-bold text-white">Topography</h3>
                        <p class="text-gray-600 dark:text-gray-400">Assessing the influence of topography on incident management, utilising topographical maps for strategic planning.</p>
                    </div>
                    <div class="p-6 bg-gray-50 rounded-lg dark:bg-gray-800">
                        <h3 class="mb-3 text-xl font-bold text-white">Response Development</h3>
                        <p class="text-gray-600 dark:text-gray-400">Applying knowledge of incident behaviour and development to predict and manage emergency situations.</p>
                    </div>
                    <div class="p-6 bg-gray-50 rounded-lg dark:bg-gray-800">
                        <h3 class="mb-3 text-xl font-bold text-white">Prediction System</h3>
